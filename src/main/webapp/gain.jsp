...
<centre>
                <c:forEach var="p" items="${details}" varStatus="status">
                <table>
				<tr><div class="name"> <h2> ${p.fname}</h2> </div></tr>
				<tr><div class="name"><h2> ${p.lname}</h2> </div></tr>
				<tr><div class="name"><h2> ${p.fathername}</h2> </div></tr>
				<tr><div class="name"><h2> ${p.dateofbirth}</h2> </div></tr>
				<tr><div class="name"><h2> ${p.email}</h2> </div></tr>
				<tr><div class="name"><h2> ${p.gender}</h2> </div></tr>
				<tr><div class="name"><h2> ${p.phoneno}</h2> </div></tr>
				<tr><div class="name"><h2> ${p.address}</h2> </div></tr>
				<tr><div class="name"><h2> ${p.state}</h2> </div></tr>
				<tr><div class="name"><h2> ${p.pincode}</h2> </div></tr>
				<tr><div class="name"><h2> ${p.adharno}</h2> </div></tr>
				</table>
				</c:forEach>	
